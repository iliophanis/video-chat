...
export const setModalInviteToChat = (
 peerId: string,
 peerUsername: string
): void => {
 const modalData = {
  modalName: 'send chat invite',
  modalContent: `Would you like to invite ${peerUsername} to chat?`,
...
export const setModalInviteRequest = (
 inviterId: string,
 inviter: User
): void => {
 const modalData = {
  modalName: 'private chat request',
  modalContent: `${inviter.username} has invited you to chat?`,
